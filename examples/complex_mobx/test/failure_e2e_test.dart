...
void main() {
  testWidgets('E2E Failure Scenario: Module Failure -> Retry -> Success', (tester) async {
    ...
    await tester.pump(const Duration(milliseconds: 100)); // Allow Future to complete/fail
